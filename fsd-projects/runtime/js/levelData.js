    ...
    var levelData = [
      {
        ...
        speed: -3,// lvl speed
        gameItems: [
          { type: "sawblade", x: 500, y: groundY - 125, damage: 10, image: "img/sawblade.png", rotate: 30, scale: 1, offsetX: -25, offsetY: -25},// obstacles
          { type: "sawblade", x: 750, y: groundY - 125, damage: 10, image: "img/lightsaber.png", rotate: 0, scale: 0.9, offsetX: -15, offsetY: -25},// obstacles
          { type: "sawblade", x: 1000, y: groundY - 125, damage: 15, image: "img/sawblade.png", rotate: 30, scale: 1, offsetX: -25, offsetY: -25},// obstacles
          ...
          { type: "reward", x: 1500, y: groundY - 75, speed: -3, image: "img/robot reward.png", scale: 0.3, offsetX: -30, offsetY: -30},//reward 2
          { type: "marker", x: 2000, y: groundY - 75, speed: -3},// next level mark
      ...
      },
      {
        ...
        speed: -3,// lvl speed
        gameItems: [
          { type: "sawblade", x: 400, y: groundY, damage: 5},// obstacles
          { type: "sawblade", x: 600, y: groundY, damage: 8},// obstacles
          { type: "sawblade", x: 900, y: groundY, damage: 6},// obstacles
      ...
      },
       {
        ...
        speed: -3,// lvl speed
        gameItems: [
          { type: "sawblade", x: 400, y: groundY, damage: 10},// obstacles
          { type: "sawblade", x: 600, y: groundY, damage: 8},// obstacles
          { type: "sawblade", x: 900, y: groundY, damage: 20},// obstacles
          { type: "sawblade", x: 500, y: groundY - 125, damage: 10},// obstacles
          { type: "sawblade", x: 800, y: groundY - 125, damage: 8},// obstacles
          { type: "sawblade", x: 1000, y: groundY - 125, damage: 50},// obstacles
          { type: "enemy", x: 1500, y: groundY - 50, speed: -5, image: "img/robot wolf.png", offsetX: -50, offsetY: -50, scale: 0.6},// enemy#2
          { type: "enemy", x: 800, y: groundY - 50, speed: -5, image: "img/robot wolf.png", offsetX: -50, offsetY: -50, scale: 0.6},// enemy#2
          ...
          { type: "reward", x: 1700, y: groundY - 75, speed: -3, image: "img/robot reward.png", scale: 0.3, offsetX: -30, offsetY: -30},//reward 2
          { type: "marker", x: 2000, y: groundY - 75, speed: -3},// next level mark
        ],
      },
      {
        ...
        gameItems: [
          { type: "sawblade", x: 400, y: groundY, damage: 10},// obstacles
          { type: "sawblade", x: 600, y: groundY, damage: 8},// obstacles
          { type: "sawblade", x: 900, y: groundY, damage: 17},// obstacles
          { type: "sawblade", x: 1500, y: groundY, damage: 13},// obstacles
          { type: "sawblade", x: 1100, y: groundY, damage: 15},// obstacles
          { type: "sawblade", x: 1300, y: groundY, damage: 30},// obstacles
          { type: "sawblade", x: 1700, y: groundY, damage: 19},// obstacles
          ...
          { type: "reward", x: 1750, y: groundY - 75, speed: -3, image: "img/robot reward.png", scale: 0.3, offsetX: -30, offsetY: -30},//reward 2
          { type: "marker", x: 3000, y: groundY - 75, speed: -3},// next level mark
        ],
      },
      {
        ...
        gameItems: [
          ...
          { type: "sawblade", x: 800, y: groundY - 125, damage: 8},// obstacles
          { type: "sawblade", x: 1000, y: groundY - 125, damage: 50},// obstacles
          { type: "sawblade", x: 1200, y: groundY - 125, damage: 50},// obstacles
          { type: "sawblade", x: 1500, y: groundY - 125, damage: 50},// obstacles
          { type: "enemy", x: 1000, y: groundY - 50, speed: -6, image: "img/robot cat.png", offsetX: -15, offsetY: -15, scale: 0.4},// enemy#3
          { type: "enemy", x: 1800, y: groundY - 50, speed: -8, image: "img/robot cat.png", offsetX: -15, offsetY: -15, scale: 0.4},// enemy#3
          ...
          { type: "enemy", x: 3000, y: groundY - 50, speed: -7, image: "img/robot lion.png", offsetX: -100, offsetY: -100, scale: 1, damage: 100},// boss#1
          { type: "reward", x: 1000, y: groundY - 75, speed: -3, image: "img/repair (1).png", scale: 0.4, offsetX: -30, offsetY: -30},// reward 1
          { type: "reward", x: 1700, y: groundY - 75, speed: -3, image: "img/robot reward.png", scale: 0.3, offsetX: -30, offsetY: -30},//reward 2
          { type: "marker", x: 4000, y: groundY - 75, speed: -3},// next level mark
        ],
      },
    ];
